...
// ↑ NUEVO: necesario para usar ThemeProvider
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // ================= BOTÓN DE PRUEBA =================
          // SOLO para validar el ThemeProvider (punto 3)
          IconButton(
            ...
            child: const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    "Gestiona todas las solicitudes de los estudiantes",
            ...
            builder: (context, snapshot) {
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              AdminDetalleSolicitudScreen(solicitud: ultima),
                        ),
                      );
                    },
                  ),
              ...
              return const Card(
                child: ListTile(
                  ...
                  title: Text("No hay solicitudes aún"),
                ),
              );
            },
          ),
